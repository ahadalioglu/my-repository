...
DATABASES = {
    'default': {
        ...
        'NAME': 'blogprojdb', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'rds-mysql.cnxsgy0md1f0.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogproj' # please enter your s3 bucket name
AWS_S3_CUSTOM_DOMAIN = '%s.ahadscloud.net' % AWS_STORAGE_BUCKET_NAME
